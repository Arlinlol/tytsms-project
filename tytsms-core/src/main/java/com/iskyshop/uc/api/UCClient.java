...
/**
 * Discuz! Ucenter API for ISkyShop,UC Client 通用调用该类来实现与UC Server之间的通信。 该类实现与UC
 * Server通信的所有接口函数,www.iskyshop.com,erikzhang
 * 
 */
public class UCClient extends PHPFunctions {
	...
	public static String UC_KEY = "123456";// iskyshop应用的KEY
	public static String UC_APPID = "2";// iskyshop应用的ID
