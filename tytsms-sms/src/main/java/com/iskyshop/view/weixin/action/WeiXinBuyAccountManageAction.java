...
@Controller
public class WeiXinBuyAccountManageAction  extends WeiXinBaseAction{
	@Autowired
	 ...
	 * @param selectCount
	 */
	@RequestMapping("/weiXin/password_modify.htm")
	 ...
	 */
	@RequestMapping("/weiXin/pay_password.htm")
	 ...
	 * @param id
	 */
	@RequestMapping("/weiXin/pay_password_setting.htm")
