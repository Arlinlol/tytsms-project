 ...
 */
@Controller
public class WeiXinCartViewAction extends WeiXinBaseAction{
	@Autowired
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/compute_cart.htm")
	 ...
	 * @param store_id
	 */
	@RequestMapping("/weiXin/cart_count_adjust.htm")
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/goods_cart0.htm")
	...
	public ModelAndView goods_cart1(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView("weiXin/view/goods_cart1.html",
	...
	public ModelAndView goods_cart2(HttpServletRequest request,
			HttpServletResponse response, String token,
			String cart_ids) {
		ModelAndView mv = new JModelAndView("weiXin/view/goods_cart2.html",
				configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/goods_cart2_goodsInfo.htm")
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/goods_cart2_payment.htm")
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/goods_cart2_cartsTrans.htm")
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/goods_cart2_coupon.htm")
	...
	public ModelAndView goods_cart3(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView("weiXin/view/goods_cart3.html",
				configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
...
//										+ addr.getArea().getAreaName());
	...
	@RequestMapping("/weiXin/payment.htm")
...
//			json_map1.put("payment_list", payments);
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/pay_payafter.htm")
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/pay_balance.htm")
...
//																	.size() - 1)));
								...
								elasticsearchUtil.indexUpdate(IndexName.GOODS, IndexType.GROUPGOODS,
										CommUtil.null2String(goods.getId()), IndexVoTools.groupGoodsToIndexVo(goods
										.getGroup_goods_list()
...
//											.updateGoodsIndex(goods));
	 ...
	 * @return
	 */
	@RequestMapping("/weiXin/pay_balance_verify.htm")
	 ...
	 * @param order_id
	 */
	@RequestMapping("/weiXin/query_payment.htm")
	 ...
	 * @param order_id
	 */
	@RequestMapping("/weiXin/query_payment_online.htm")
	 ...
	 * @param order_id
	 */
	@RequestMapping("/weiXin/buyer_order_payment_save.htm")
	...
	@SecurityMapping(title = "订单支付", value = "/weiXin/order_pay.htm*", rtype = "buyer", rname = "购物流程3", rcode = "goods_cart", rgroup = "在线购物")
		...
		if (order != null && order.getOrder_status() == 10) {
			if (CommUtil.null2String(payType).equals("")) {
				...
				if (payType.equals("balance")) {// 使用预存款支付
					...
					mv = new JModelAndView("weiXin/view/line_pay.html",
							configService.getSysConfig(),
							this.userConfigService.getUserConfig(), 1, request,
							response);
