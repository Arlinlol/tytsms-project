...
@Controller
public class MobileWapBuyAccountManageAction  extends MobileWapBaseAction{
	@Autowired
	 ...
	 * @param selectCount
	 */
	@RequestMapping("/mobileWap/password_modify.htm")
	 ...
	 */
	@RequestMapping("/mobileWap/pay_password.htm")
	 ...
	 * @param id
	 */
	@RequestMapping("/mobileWap/pay_password_setting.htm")
