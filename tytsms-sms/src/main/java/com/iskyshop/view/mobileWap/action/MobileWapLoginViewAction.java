 ...
 */
@Controller
public class MobileWapLoginViewAction  extends MobileWapBaseAction{
	@Autowired
	 ...
	 * @return
	 */
	@RequestMapping("/mobileWap/iskyshop_user_login.htm")
	 ...
	 * @return
	 */
	@RequestMapping("/mobileWap/login.htm")
	public ModelAndView mobile_login(HttpServletRequest request,
			HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("mobileWap/view/login.html",
	 ...
	 */
	@RequestMapping("/mobileWap/register_finish.htm")
	 ...
	 * 
	 */
	@RequestMapping("/mobileWap/register_doc.htm")
	public ModelAndView mobile_register_doc(HttpServletRequest request,
			HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("mobileWap/view/doc.html",
				configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
	 ...
	 * 
	 */
	@RequestMapping("/mobileWap/register.htm")
	public ModelAndView mobile_register(HttpServletRequest request,
			HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("mobileWap/view/register.html",
				configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
		return mv;
	}
	...
	@RequestMapping("/mobileWap/user/verify_mobile.htm")
	...
	@RequestMapping("/mobileWap/user/sendMsg.htm")
	 ...
	 * 
	 */
	@RequestMapping("/mobileWap/logout.htm")
	public void loginOut(HttpServletRequest request,
			HttpServletResponse response) {
		try {
			HttpSession session = request.getSession();
			session.putValue("user_id", null);
