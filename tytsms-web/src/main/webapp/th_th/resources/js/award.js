jQuery(document).ready(function(){		
	  ...
	  //});
	    function startRequest() {  
	        ...
	        jQuery.ajax({  
	            ...
	            success: function (json) {  
	                var temp = "";  
	                jQuery.each(json, function (i, c) {  										/*抽中了*/
	                   temp += "<li><div class=\"name\">"+c.userName+"</div><div class=\"ym\">จับได้รางวัลแล้ว<span>"+c.awardName+"</span></div></li>";
	                });  
			...
			if(lock){
				...
				type : 'POST',
					...
					error : function() {
						...
						strHtml +="<span class='tip_box_txt'>หมดเวลาเครือข่าย โปรดตรวจสอบการตั้งค่าอินเทอร์เน็ตของคุณ!</span></div> </div>";
						jQuery(".adraw_dialog_content").append(strHtml);	/*网络超时，请检查您的网络设置！*/
						lock = true;
				 		return false;
					},
					success : function(json) {
		...
		window._bd_share_config={
			"common":{
		       "bdText":"กิจกรรมจับรางวัลทอดรองใช้เว็บไซต์ไทยี่เถา",/*泰易淘试运营抽奖活动*/
