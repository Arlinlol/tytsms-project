...
function cmd() {
	...
	if (mulitId != "") {
		...
		if (confirm("ยืนยันจะดำเนินการนี้หรือไม่")) {/*确定要执行该操作？*/
			jQuery("#ListForm").attr("action", url);
			jQuery("#ListForm").submit();
		}
	} else {
		alert("อย่างน้อยต้องเลือกข้อมูลหนึ่งข้อ");/*至少选择一条数据记录*/
	}
}
/**
 * / /* 火狐下取本地全路径
...
function showDialog() {
	...
	var s = "<div id='"
			...
			+ second		/*秒后窗口关闭*/
			+ "</span>หลังจากหนึ่งวินาทีหน้าต่างจะปิด</h3></div></div></div><div class='black_overlay'></div>";
	...
	var c = "<div id='"
			...
			+ "'></span><span class='message_white_font'>"
			+ content																				/*确定*/										/*取消*/
			+ "</span></div>   <div class='message_white_box1'><input id='sure' type='button' value='ยืนยัน'/><input id='cancel' type='button' value='ยกเลิก'/></div>    </div></div></div><div class='black_overlay'></div>";

	var m = "<div id='"
			+ id																											/*我要发布*/
			+ "'><div class='release_page'> <div class='release_page_title'><span class='release_page_title_left'>ฉันจะแชร์</span><span class='release_page_title_right'><a href='javascript:void(0);' onclick='javascript:jQuery(\"#"
			+ id																																																																	/*宝贝*/				/*晒出喜欢的宝贝*/																																																												/*店铺*/					/*分享精品店铺*/
			+ "\").remove();'>×</a></span></div><div class='release_page_ul'><ul>																						<li class='baby'><a href='javascript:void(0);' id='share_select_3' share_mark='3'><div class='margin'><span>สินค้า</span><br />แชร์สินค้าที่คุณชอบ </div></a></li>																														<li class='pictures'><a href='javascript:void(0);' id='share_select_4' share_mark='4'><div class='margin'><span>ร้านค้า</span><br /> แบ่งปันร้านค้ายอดนิยม</div></a></li>																															<li class='article'><a href='javascript:void(0);' id='share_select_5' share_mark='5'><div class='margin'><span>新鲜事</span><br />写心得写攻略</div></a></li></ul></div></div><div class='black_overlay'></div>";
	...
	var a = "<div id='"
			...
			+ id																				/*正文*/																					/*生活每天都有新鲜事.每天都来聊一聊*/																																				/*分 享*/
			+ "\").remove();'>×</a></span></div><div class='article_page_main'><div class='h2'><h2>บทความ</h2></div><textarea id='select_share_dynamic' name='select_share_dynamic' placeholder='ชีวิตทุกวันมีเรื่องราวใหม่ๆ. มาแชททุกๆวัน'></textarea><div class='article_page_bottom'><div class='article_page_input_left' id='input_show_error'></div><input type='button' value='การแบ่งปัน' id='select_button_dynamic' share_mark='dynamic' /></div></div></div><div class='black_overlay'></div></div>"
	...
	jQuery("input[id^=select_button_]").click(function() {
		...
		if (content.length > 0) {
			if (content.length > 140) {
				jQuery("#input_show_error").html("คำที่กรอกเข้าไม่สามารถเกิน 140 ตัว");/*输入字数不能多于140个字！*/
			} else {
			...
			jQuery("#input_show_error").html("กรุณากรอกเนื้อหา");/*请输入内容！*/
		}
	});
...
function dialogLogin(dialog_uri) {
	var dialog_title = "เข้าสู่ระบบสมาชิก";/*会员登录*/
